...
<body style="background-color:#E5E4FD;
	width:100%;">
  ...
  <div class="coli">
	...
	<h2>Sistemas de Alarmas electrónicos</h2>
      ...
      <div class="contini">
        ...
        <p><button class="boti" onclick="location.href='contacto.php'">Contactanos</button></p>
      </div>
    </div></div>
	<div class="coli">
    <div class="cardi">
...
<button width="100" height="30" onclick="location.href='contacto.php'" style="color:white; background-color:grey	">CONTACTANOS!</button><br/><br/>
</p>
